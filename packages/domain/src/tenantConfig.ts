 ...
 * Starts from profile defaults, then layers explicit overrides.
 * Does not invent marketplace / access-control modules.
 */
export function applyTenantProfilePack(input: {
  profile: TenantProfile;
  /** When true (profile changed), restamp categories/terminology from pack. */
