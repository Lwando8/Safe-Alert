/**
 * Responder capability helpers — hybrid Phase D.
 * Shared vocabulary for security vs maintenance assignment filters.
 */
...
export function requiredCapabilitiesForIncident(_incidentType?: string | null): string[] {
  return ['INCIDENT_RESPONSE'];
}

export function requiredCapabilitiesForRequestCategory(
