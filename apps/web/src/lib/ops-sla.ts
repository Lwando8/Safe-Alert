/**
 * Ops web SLA helpers — re-export / thin wrapper for client+server.
 * Prefer @seren/domain when available; keep local copy for Next edge safety.
 */
...
const DEFAULT_SLA_MS = DEFAULT_SLA_MS_BY_PRIORITY.normal!;
const SLA_DUE_SOON_FRACTION = 0.2;
