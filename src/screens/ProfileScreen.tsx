...
const QuickAction = ({
  ...
  <TouchableOpacity style={styles.quickActionContainer} onPress={onPress}>
    ...
    <Text style={[styles.quickActionLabel, { color: labelColor }]} numberOfLines={2}>
      {label}
    </Text>
  </TouchableOpacity>
);
...
export default function ProfileScreen() {
  ...
  const profileActions = [
    ...
    {
      title: 'Medical Info',
      icon: <Ionicons name="medical" size={22} color={theme.hospital} />,
      color: theme.hospitalGlass,
      onPress: () => navigation.navigate('MedicalInfo' as never),
    },
    {
      title: 'Settings',
      icon: <Ionicons name="settings" size={22} color={theme.monitor} />,
      color: theme.monitorGlass,
      onPress: () => navigation.navigate('Settings' as never),
    },
    {
      title: 'Emergency',
      icon: <Ionicons name="pulse" size={22} color={theme.emergency} />,
      color: theme.emergencyGlass,
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.content}>
            ...
            <GlassCard style={styles.section}>
              ...
              <View style={styles.linksList}>
                <TouchableOpacity 
                  ...
                  onPress={() => navigation.getParent()?.navigate('Community' as never)}
                >
                  <View style={[styles.linkIcon, { backgroundColor: theme.contact }]}>
                    <Ionicons name="people" size={16} color="#fff" />
                  </View>
                  <Text style={[styles.linkText, { color: theme.text }]}>My Community</Text>
            ...
            <TouchableOpacity
              ...
              onPress={logout}
            >
              <Ionicons name="log-out" size={20} color={theme.textOnPrimary} />
              <Text style={[styles.logoutText, { color: theme.textOnPrimary }]}>Logout</Text>
            </TouchableOpacity>
