...
export default function EmergencyMonitoringScreen() {
  ...
  const handleSOSPress = () => {
    ...
    Alert.alert(
      'EMERGENCY SOS',
      'This will send an emergency alert to all your contacts and emergency services. Continue?',
      [
        { 
          text: 'Cancel', 
          style: 'cancel',
  ...
  const triggerEmergencyAlert = async () => {
    console.log('SOS EMERGENCY ALERT TRIGGERED');
  ...
  const triggerMedicalAlert = async () => {
    ...
    Alert.alert(
      'MEDICAL ALERT SENT!',
      'Ambulance services have been contacted. Medical help is on the way.',
      [{ text: 'OK' }]
    );
  };

  const triggerSecurityAlert = async () => {
    console.log('SECURITY EMERGENCY ALERT TRIGGERED');
    
    Alert.alert(
      'SECURITY ALERT SENT!',
      'Armed response has been notified. Security assistance is on the way.',
      [{ text: 'OK' }]
    );
  };
        ...
        {isEmergencyActive && (
          <View style={createStyles(theme).emergencyStatus}>
            ...
            {countdown > 0 && (
              ...
              >
                <Text style={createStyles(theme).cancelButtonText}>CANCEL</Text>
              </TouchableOpacity>
            )}
          </View>
        )}
        ...
        <View style={createStyles(theme).secondaryAlertsContainer}>
          ...
          <View style={createStyles(theme).alertButtonsRow}>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.8}
            >
              <View style={[createStyles(theme).alertCircle, { backgroundColor: '#e74c3c' }]}>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.8}
            >
              <View style={[createStyles(theme).alertCircle, { backgroundColor: '#3498db' }]}>
