...
import { AuthError, registerClient } from '../services/AuthService';
...
export default function RegisterScreen({ navigation }: Props) {
  ...
  const handleRegister = async () => {
    try {
      ...
      Alert.alert(
        'Success',
        'Citizen account created. Sign in with Citizen mode.',
        [
          {
            text: 'OK',
            ...
            <View style={styles.header}>
              <GlassCard style={styles.logoCard}>
                ...
                <Text style={[styles.subtitle, { color: theme.textSecondary }]}>
                  Citizen accounts only. Responder access is provisioned by your organization.
                </Text>
              </GlassCard>
            </View>
